...
//Motor
long motor_duration = 60000; //1 min
const long min_motor_delay = 1 * 60000; //10 min
...
const long randsound_min = 2 * 60000; //3min
const long randsound_max = 4 * 60000; //6min
...
long set_randsound_interval(){
    if (!digitalRead(randsoundintervalpin)){
      randsound_duration = randsound_duration +60000; //up by 1 min
